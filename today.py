...
USER_NAME = os.environ['USER_NAME'] # 'DycandX'
...
if __name__ == '__main__':
    """
    Zulvikar Kharisma N M (DycandX), 2022-2026
    """
    print('Calculation times:')
    # define global variable for owner ID and calculate user's creation date
    # e.g {'id': 'U_kgDOBjCZGg'} and 2022-04-16T17:22:01Z for username 'DycandX'
    user_data, user_time = perf_counter(user_getter, USER_NAME)
    OWNER_ID, acc_date = user_data
    formatter('account data', user_time)
    age_data, age_time = perf_counter(daily_readme, datetime.datetime(2004, 4, 28))
    ...
    if OWNER_ID == {'id': 'U_kgDOBjCZGg'}: # only calculate for user DycandX
